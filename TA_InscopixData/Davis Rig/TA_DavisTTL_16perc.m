...
for i = 1:length(infile)
    ...
    [psth_a{1}, psth_none{1}, psth_inhib{1}, act{1}]=Heatmap_quant_TA(psth{1}, 'Title', baseline, baseline);
    [psth_a{2}, psth_none{2}, psth_inhib{2}, act{2}]=Heatmap_quant_TA(psth{13}, 'Title', baseline, baseline);
    [psth_a{3}, psth_none{3}, psth_inhib{3}, act{3}]=Heatmap_quant_TA(psth{25}, 'Title', baseline, baseline);
