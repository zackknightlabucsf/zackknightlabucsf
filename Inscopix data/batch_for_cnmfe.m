...
vidlist={
'JG_111121_DV2ex1-pp-BP-MC.tiff' 
    'JG_102621_DV2ex2-pp-BP-MC.tiff' 
    'JG_111121_DV2ex2-pp-BP-MC.tiff' 
    'JG_111121_DVDL102-pp-BP-MC.tiff'
    'JG_111121_DVDL103-pp-BP-MC.tiff'
    'JG_111121_DVDL101-pp-BP-MC.tiff'
    'JG_111021_DV2ex1-pp-BP-MC.tiff'
    'JG_110921_DVDL102-pp-BP-MC.tiff'
    'JG_110921_DVDL103-pp-BP-MC.tiff'
    'JG_110821_DV2ex5-pp-BP-MC.tiff'
    'JG_110821_DV2ex2-pp-BP-MC.tiff'
    'JG_110821_DVDL102-pp-BP-MC.tiff'
    'JG_110821_DVDL103-pp-BP-MC.tiff'
    'JG110521_DVDL102-pp-BP-MC.tiff'
    'JG_110321_DV2ex5-pp-BP-MC.tiff'
    'JG_110321_DV2ex6-pp-BP-MC.tiff'
    'JG_110321_DV2ex2-pp-BP-MC.tiff'
    'JG_110221_DV2ex5-pp-BP-MC.tiff'
    'JG_110221_DV2ex2-pp-BP-MC.tiff'
    'JG_110121_DV2ex5-pp-BP-MC.tiff'
    'JG_110121_DV2ex2-pp-BP-MC.tiff'
    'JG_103021_DV2ex5-pp-BP-MC.tiff'
    'JG_103021_DV2ex2-pp-BP-MC.tiff'
    'JG_102821_DV2ex2-pp-BP-MC.tiff'
   'JG_102721_DV2ex5-pp-BP-MC.tiff'
    'JG_102721_DV2ex2-pp-BP-MC.tiff'
    'JG_102621_DV2ex5-pp-BP-MC.tiff'
};
...
for id=1:length(vidlist)
    ...
    nam=which(vidlist{id});
    cnmfe_choose_data;
    %% create Source2D class object for storing results and parameters
    ssub = 1;           % spatial downsampling factor
    tsub = 1;           % temporal downsampling factor
    Fs = 4/tsub;             % frame rate
    ...
    parfor i = 1:length(patches)
        ...
        if nC>0 % check for presence of neurons in patch
            ...
            while miter <= maxIter
                ...
                if miter ==1
                    merge_thr = [0.4, 0.8, .1];     % thresholds for merging neurons
...
%     eval(sprintf('save %s%s%s_results.mat %s', dir_nm, filesep, file_nm, strjoin(globalVars)));
    try
        save(strcat(file_nm,'_lowPNR_wspace.mat'))
    catch
        save(num2str(id))
    end
