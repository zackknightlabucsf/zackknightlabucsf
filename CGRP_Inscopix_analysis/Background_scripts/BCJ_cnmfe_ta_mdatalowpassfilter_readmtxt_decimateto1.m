...
%     keyboard();
    %this line controls ranking in Tara's scripts
    [rerank,ind_rerank] = cnmfe_yc_rankPSTH(tpsthnom,[1:pretime],[pretime:pretime+300]);
...
[ all_mrerank,ind_mrerank ] = cnmfe_yc_rankPSTH(mpsthnom,[1:pretime],[pretime:pretime+300]);
